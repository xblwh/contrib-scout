...
想了解实际使用过程，可点击首页「阅读真实使用记录」，或阅读[案例说明](docs/case-study.md)。记录展示如何用调研结果推动工具改进、验证、提交并合并至自有项目；已去除身份与贡献定位信息，明确审核角色和证据边界。它不代表第三方维护者已接受贡献。普通导出报告仍含来源链接和摘录，分享前需要另行检查。
